...
const createProductCard = (rentalItem) => /*html*/ `<div class="card-body w-[300px] shrink-0">
	<div class="m-b-30 space-y-[30px] w-full">
		...
		<div class="col-md-7 col-xxl-12">
			<div class="new-arrival-content position-relative">
				<h4>${rentalItem.ItemName}</h4>
				<p>Location: <span class="item">${rentalItem.location} </span></p>
				<p>
					Price: <i class="fa fa-check-circle text-success"></i> &#8358;
					${Number(rentalItem.Price).toLocaleString()}
				</p>
...
const createItemDetailsRow = (itemInfo) => /*html*/ `<tr data-payment-id="${itemInfo.payment_id}">
	...
	<td class="py-2">
		<span
			class="badge light  badge-lg ${itemInfo.status === "Approved" ? "badge-success" : "badge-warning"}"
		>
			${itemInfo.status}
			${
...
const createTransactionEntry = (
	transactionInfo
) => /*html*/ `<div class="d-flex align-items-center student">
